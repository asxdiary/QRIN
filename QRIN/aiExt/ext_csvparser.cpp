#ifndef ASX_ext_csvparser_cpp
#define ASX_ext_csvparser_cpp
...
CsvParser* aiExt::CsvParser_new(const char *filePath, const char *delimiter, int firstLineIsHeader) {
...
CsvParser* aiExt::CsvParser_new_from_string(const char *csvString, const char *delimiter, int firstLineIsHeader) {
...
void aiExt::CsvParser_destroy(CsvParser *csvParser) {
    if (csvParser == NULL) {
        return;
    }
...
void aiExt::CsvParser_destroy_row(CsvRow *csvRow) {
    int i;
...
CsvRow* aiExt::CsvParser_getHeader(CsvParser *csvParser) {
...
CsvRow* aiExt::CsvParser_getRow(CsvParser *csvParser) {
...
int aiExt::CsvParser_getNumFields(CsvRow *csvRow) {
    return csvRow->numOfFields_;
}

char** aiExt::CsvParser_getFields(CsvRow *csvRow) {
    return csvRow->fields_;
}

CsvRow* aiExt::_CsvParser_getRow(CsvParser *csvParser) {
    int numRowRealloc = 0;
...
int aiExt::_CsvParser_delimiterIsAccepted(const char *delimiter) {
...
void aiExt::_CsvParser_setErrorMessage(CsvParser *csvParser, const char *errorMessage) {
    if (csvParser->errMsg_ != NULL) {
        free(csvParser->errMsg_);
    }
...
const char* aiExt::CsvParser_getErrorMessage(CsvParser *csvParser) {
